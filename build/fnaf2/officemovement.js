...
export default class OfficeMovement extends VisualAspect {
    static async init(root, parent) {
        ...
        /** @type {Graphics} */
        this.leftRegion = this.add(new Graphics().rect(0, 0, root.nativeResolution.x*0.35, root.nativeResolution.y).fill(0xffff00));
        ...
        /** @type {Graphics} */
        this.rightRegion = this.add(new Graphics().rect(root.nativeResolution.x*0.55, 0, root.nativeResolution.x*0.35, root.nativeResolution.y).fill(0x00ff00));
